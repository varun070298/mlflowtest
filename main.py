...
if __name__ == "__main__":
    ...
    df = df.assign(A4xA6=a,A5xA7=b,A8xA11=c,A9xA12=d,A10xA13=e,N1xN2=f,N4xN5=g,N8xN9=h,N11xN12=i,N13xN4=j,N15xN16=k,N18xN19=l)


    X_train, X_test, Y_train, Y_test = train_test_split(df.iloc[:,1:53], df['AimoScore'], test_size = 0.1, random_state = 41)
